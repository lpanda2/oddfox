...
var or__33170__auto__ = goog.object.get(goog.global,"FIGWHEEL_WEBSOCKET_CLASS");
if(cljs.core.truth_(or__33170__auto__)){
return or__33170__auto__;
} else {
var or__33170__auto____$1 = goog.object.get(goog.global,"WebSocket");
if(cljs.core.truth_(or__33170__auto____$1)){
return or__33170__auto____$1;
} else {
...
var and__33158__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__33158__auto__){
var and__33158__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__33158__auto____$1)){
var and__33158__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
if(and__33158__auto____$2){
return cljs.core.swap_BANG_.call(null,figwheel.client.socket.message_history_atom,cljs.core.conj,msg);
} else {
return and__33158__auto____$2;
}
} else {
return and__33158__auto____$1;
}
} else {
return and__33158__auto__;
}
});
figwheel.client.socket.open = (function figwheel$client$socket$open(p__36515){
...
var opts = map__36516__$1;
var retry_count = cljs.core.get.call(null,map__36516__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__36516__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__36516__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__36516__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__33170__auto__ = retried_count;
if(cljs.core.truth_(or__33170__auto__)){
return or__33170__auto__;
} else {
return (0);
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__33527__auto__ = (10000);
var y__33528__auto__ = ((2000) + ((500) * retried_count__$1));
return ((x__33527__auto__ < y__33528__auto__) ? x__33527__auto__ : y__33528__auto__);
})());
} else {
return null;
}
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__36516,map__36516__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1530400738412
