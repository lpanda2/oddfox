...
var or__33170__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34838 = {"detail":data};
return obj34838;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__33158__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__33158__auto__)){
var and__33158__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34845 = cljs.core._EQ_;
var expr__34846 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34845.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34846))){
return ((function (pred__34845,expr__34846){
return (function (p1__34839_SHARP_){
return console.warn(p1__34839_SHARP_);
});
;})(pred__34845,expr__34846))
} else {
if(cljs.core.truth_(pred__34845.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34846))){
return ((function (pred__34845,expr__34846){
return (function (p1__34840_SHARP_){
return console.debug(p1__34840_SHARP_);
});
;})(pred__34845,expr__34846))
} else {
if(cljs.core.truth_(pred__34845.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34846))){
return ((function (pred__34845,expr__34846){
return (function (p1__34841_SHARP_){
return console.error(p1__34841_SHARP_);
});
;})(pred__34845,expr__34846))
} else {
return ((function (pred__34845,expr__34846){
return (function (p1__34842_SHARP_){
return console.log(p1__34842_SHARP_);
});
;})(pred__34845,expr__34846))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34849){
...
var eval_fn = cljs.core.get.call(null,map__34850__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34852_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34854,(0),null);
...
if(cljs.core.truth_((function (){var and__33158__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1530400737183
