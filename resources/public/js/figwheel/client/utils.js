...
return (new CustomEvent(event_name,(function (){var obj35202 = {"detail":data};
return obj35202;
})()));
} else {
...
var f = (function (){var pred__35209 = cljs.core._EQ_;
var expr__35210 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35209.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35210))){
return ((function (pred__35209,expr__35210){
return (function (p1__35203_SHARP_){
return console.warn(p1__35203_SHARP_);
});
;})(pred__35209,expr__35210))
} else {
if(cljs.core.truth_(pred__35209.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35210))){
return ((function (pred__35209,expr__35210){
return (function (p1__35204_SHARP_){
return console.debug(p1__35204_SHARP_);
});
;})(pred__35209,expr__35210))
} else {
if(cljs.core.truth_(pred__35209.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35210))){
return ((function (pred__35209,expr__35210){
return (function (p1__35205_SHARP_){
return console.error(p1__35205_SHARP_);
});
;})(pred__35209,expr__35210))
} else {
return ((function (pred__35209,expr__35210){
return (function (p1__35206_SHARP_){
return console.log(p1__35206_SHARP_);
});
;})(pred__35209,expr__35210))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35213){
...
var opts = map__35214__$1;
var eval_fn = cljs.core.get.call(null,map__35214__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35216_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35218,(0),null);
var v = cljs.core.nth.call(null,vec__35218,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530314316660
